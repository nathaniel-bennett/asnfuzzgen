...
pub(super) fn generate_aper_codec_for_asn_open_type(
    ...
    let (
        ...
        (
            ...
            quote!(asnfuzzgen_codecs::PerCodecData::new_aper),
            quote!(aper_encode),
            quote!(aper_decode),
        ...
        (
            ...
            quote!(asnfuzzgen_codecs::PerCodecData::new_uper),
            quote!(uper_encode),
            quote!(uper_decode),
        ...
        impl #codec_path for #name {
            ...
            fn #codec_decode_fn(data: &mut asnfuzzgen_codecs::PerCodecData) -> Result<Self::Output, asnfuzzgen_codecs::PerCodecError> {
                ...
                match key {
                    ...
                    _ => Err(asnfuzzgen_codecs::PerCodecError::new(format!("Key {} Not Found", key).as_str()))
                }
            }

...
impl Default for Asn1Compiler {
    fn default() -> Self {
        Asn1Compiler::new("default.rs", &Visibility::Public, Codec::Aper, vec![])
    }
}

impl Asn1Compiler {
    /// Create a new Instance of the Compiler structure.
    pub fn new(output: &str, visibility: &Visibility, codec: Codec, derives: Vec<Derive>) -> Self {
        Asn1Compiler {
            modules: HashMap::new(),
            resolver: Resolver::new(),
            generator: Generator::new(visibility, codec, derives), // FIXME: Hard coded
